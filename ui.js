...
function displayRecommendation(new_word){
    if(rList.length > 0){
        ...
        var code_out = "<p class='lead' style='color: #777777;'>" + dots + "Similar Words" + dots + "</p><span class='list-group' style='max-width: 250px; display: block; box-shadow: 2px 2px 5px #EEE;'></div>";
        ...
        for(var i = 0; i < rList.length && i < max_num_of_items; i++){
            ...
            else code_out += "<a href=https://www.google.com/search?q=" + rList[i] + " target='_blank' class='list-group-item'>" + rList[i] + "</a>";
        }
        code_out += "</span>";
